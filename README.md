...
- 🚀 Implement a button in the user settings menu, as well as a basic pull-to-refresh mechanism on mobile, to immediately fetch any updated website data (by default fetched automatically every 30 mins)
